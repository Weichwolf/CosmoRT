...
- [x] Scancode-Mapping: Linux KEY_* Codes (nicht USB HID)
- [x] Echo-Flush: Wake blocked reader auf output_buf, Flush vor Re-Block
- [x] Blocking PTY read (Thread schlaeft, Wake bei Keyboard-IRQ)
- [x] Hack Font 1546 Glyphen, bilinear skaliert, Alpha-Blit
- [x] BMW Bernstein Farbpalette (Amber auf Schwarz)
...
Prio 2 — Interaktives CosmoOS:
  (VT Keyboard, INOTIFY Events, dlopen — erledigt)
