...
SKIP="mntent mntent-static strptime strptime-static raise-race raise-race-static pthread-robust-detach pthread-robust-detach-static pthread_mutex_pi-static tls_init"
